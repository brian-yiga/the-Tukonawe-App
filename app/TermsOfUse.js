      ...
      >
        <View style={styles.content}>
          ...
          <Text style={styles.sectionText}>
            Welcome to theCalmSpace. These terms of use apply to your use of our
            application and services. By accessing and using theCalmSpace, you
          ...
          <Text style={styles.sectionText}>
            ...
            deliver the services you request, send periodic emails, and improve
            our app based on your feedback.
          </Text>
