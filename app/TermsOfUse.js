        ...
        >
          <View style={styles.content}>
            ...
            <Text style={styles.sectionText}>
              Welcome to theCalmSpace. These terms of use apply to your use of
              our application and services. By accessing and using theCalmSpace,
            ...
            <Text style={styles.sectionText}>
              ...
              materials (information or software) on theCalmSpace for personal,
            ...
            <Text style={styles.listItem}>
              • Attempting to decompile or reverse engineering any software
            </Text>
            <Text style={styles.listItem}>
            ...
            <Text style={styles.sectionText}>
              The materials on theCalmSpace are provided "as is". We make no
              warranties, expressed or implied, and hereby disclaim and negate
            ...
            <Text style={styles.sectionText}>
              ...
              we collect, use, disclose, and otherwise handle your information
            ...
            <Text style={styles.sectionText}>
              ...
              information we may collect on the application includes:
            </Text>
            <Text style={styles.listItem}>
            ...
            <Text style={styles.sectionText}>
              ...
              deliver the services you request, send periodic emails, and
            ...
            <Text style={styles.sectionText}>
              If you have any questions about these Terms of Use or Privacy
              Policy, please contact us at support@thecalmspace.com
            </Text>
...
const styles = StyleSheet.create({
  ...
  backButton: { color: COLORS.sageGreen, fontSize: 16, fontWeight: "600" },
